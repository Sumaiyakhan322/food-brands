...
const Team = () => {
    ...
    <h2 className="my-30 font-bold text-red-900 text-center text-2xl md:text-5xl  ">Our team</h2>
        <hr
      className="my-12  h-px border-t-0  bg-gradient-to-r from-transparent via-red-900 to-transparent opacity-25 dark:opacity-100"
       />
            ...
            <ul className="mx-auto flex list-inside justify-center">
              <a href="#!" className="px-2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                  className="h-4 w-4 text-red-900 dark:text-red-900-400">
              ...
              <a href="#!" className="px-2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                  className="h-3.5 w-3.5 text-red-900 dark:text-red-900-400">
                  <path fill="currentColor"
          ...
          <div className="p-6">
            ...
            <ul className="mx-auto flex list-inside justify-center">
              <a href="#!" className="px-2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-red-900 dark:text-red-900-400"
