          ...
          <div className="grid-1 grid gap-8 grid-cols-1 md:grid-cols-3">
            <div className="">
              <h6 className="mb-4 flex items-center justify-center font-semibold uppercase md:justify-start">
                <img
                  src={logo}
                  className="md:w-22 md:h-16 w-15 h-10 rounded-lg"
                  alt=""
                />
              </h6>
              <p>
                ...
                , Showcase a wide range of food and beverage products, allowing users to browse and explore your offerings with high-quality images and detailed descriptions.
              </p>
            </div>
